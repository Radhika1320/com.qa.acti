...
public class DriverScript {
	...
	// static because we need use the driver reference in any packages under this
	// project
	public static WebDriver driver;

	Properties prop;// global variable
	/*
	 * This constructor is responsible for getting the details from the properties file
	 */
	...
	/*
	 * initapplication  method will get the browser details from properties file and launch the application
	 */
